...
import com.moriarity_code.trackyourfit.utility.Constants.LOCATION_UPDATE_INTERVAL
...
import com.moriarity_code.trackyourfit.utility.Constants.TIMER_UPDATE_INTERVAL
...
class TrackingService : LifecycleService() {
    ...
    private fun updateLocationTracking(isTracking: Boolean) {
        if (isTracking) {
            if (TrackingUtility.checkLocationPermission(this)) {
